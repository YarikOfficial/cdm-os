...
# V2.5      Mods to remove AMES Extensions and IO for Platforms 2021.

title = 'CocoIDE V2.5'  # Should be updated to reflect version
...
class CocoIDE(tk.Frame):
    ...
    def helpwin(self, event=None):
        ...
        try:
            ...
            self.statusMsg.config(text="Help File Not Found")
