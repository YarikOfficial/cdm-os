...
os_string_help> dc "Available commands: help, ls, count, sum, input, calc, countbg, sumbg, kill1, kill2, ps, tasks\n", 0
os_string_ls> dc "count\nsum\ninput\ncalc\ncountbg\nsumbg\nkill1\nkill2\nps\ntasks\n", 0

os_string_count> dc "Program 1 started!\n", 0
os_string_sum> dc "Program 2 started!\n", 0
...
os_string_sumbg_started> dc "sum started in background\n", 0
os_string_countbg_stopped> dc "count background stopped\n", 0
os_string_sumbg_stopped> dc "sum background stopped\n", 0
os_string_ps_header> dc "PID NAME  STATE TICKS\n", 0
os_string_ps_task1> dc "1   count ", 0
os_string_ps_task2> dc "2   sum ", 0
